...
## Stack
HTML/CSS/JavaScript estáticos para a publicação e Python padrão para CLI/servidor local, conforme o plano cuja implementação foi solicitada.
...
Sem diagnóstico, decisões jurídicas, transações ou mensagens externas. Sem chave Jev disponível na sessão. Dados do usuário nunca publicados.
