...
identity:
  ...
  description:
    full: >-
      Consultar Jev pelo OpenRouter para classificar informações entre alternativas,
      avaliar sim/não ou aplicar uma rubrica. Use quando o usuário pedir uma decisão
      estruturada com Jev; para integrar sistemas, use jev-integrar.
activation:
  triggers:
    - jev
    - decisão estruturada
