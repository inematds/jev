...
2. Localize o clone `inematds/jev`. Se não existir, obtenha o código de https://github.com/inematds/jev em uma pasta de trabalho adequada. Leia `pacotes/python/README.md` e a receita relevante em `pacotes/receitas/README.md` desse clone.
