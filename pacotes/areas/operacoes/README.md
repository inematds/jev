...
**Ponto de integração:** Use atualizações do projeto como entrada antes da reunião de acompanhamento.

**Uso da saída:** Sugerir tipo de pendência; manter prazo e responsável sob controle da equipe.
...
No exemplo, a classificação esperada é **dependencia**. O valor de confidence da fixture é inventado. A alternativa `revisar` e as alternativas de insuficiência continuam sob revisão mesmo com confidence alta. Sugestões não executam ações por conta própria.
