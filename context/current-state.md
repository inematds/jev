...
19/09/2026 · v1.3.1. Laboratório ampliado para 20 casos, Choice/Noul/Score, perguntas combinadas, estado JSON, importação/exportação, custo completo e leitura de relatórios. CLI experiment e compare: regras, Jev direto, híbrido e replay, com hashes, procedência, falhas e métricas.
