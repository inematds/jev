...
18/09/2026 · v1.1.1. Implementados: laboratório estático com dez exemplos autorais simulados, exportação de requisição, política didática e calculadora; núcleo Python com validação Choice/Noul/Score, cliente real de API com prazo/retries e CLI; servidor local com lista fechada de arquivos; baseline em lote e relatórios.
